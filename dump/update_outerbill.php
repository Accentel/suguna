...
mysql_query($e); 
 ...
 $e="update outerbill1 set PatientName='$pname',time='$time', Age='$age', Sex='$gender', DoctorName='$dname', Total='$tot', Discount='$conamt', NetAmount='$price', PaidAmount='$paid', BalanceAmount='$bal' where BillNO='$bno'";
$sql1=mysql_query($e);
