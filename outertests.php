...
<table width="100%" cellpadding="0" cellspacing="0"> 
	...
	<tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header">Outer Patients Tests List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
                ...
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                       ...
                       <tr>
                        ...
                        <?php
							$qry=mysqli_query($link,"select distinct TestName,Amount from outerbill where BillDate between '$sdate1' and '$edate1'") or die(mysqli_error($link));
							if($qry){
								$i=0;
								$grand = 0;
								while($row = mysqli_fetch_array($qry)){
									$tname = $row['TestName'];
									$amt = $row['Amount'];
									$qry1=mysqli_query($link,"select count(TestName) from outerbill where BillDate between '$sdate1' and '$edate1' and TestName='$tname'") or die(mysqli_error($link));
									if($qry1)
									{
