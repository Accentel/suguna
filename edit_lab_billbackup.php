...
<html>
	...
	<div id="conteneur">
		...
		<?php
			//include("config.php");
			$bno = $_REQUEST['bno'];
			$sql = mysqli_query($link,"select b.BillNO,b.BillDate,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.phoneno,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from bill b,bill1 b1 where b.BillNO=b1.BillNO and  b.BillNO = '$bno'");
			if($sql){
			...
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
					...
					<tr >
                        ...
                        <td align="left" >
							...
							<?php
								//include("config.php");
								$sql1 = mysqli_query($link,"select DoctorName from ddetails");
								if($sql1){
					...
					<table width="100%" id="TABLE1">
					  ...
					  <th width="50%" class="TH1">Delete</th>
					   ...
					   <?php 
						$sql2 = mysqli_query($link,"select * from bill where BillNO = '$bno'");
						if($sql2){
				...
				<!--	<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="tot" value="<?php echo $tot ?>"  id="tot" class="text" readonly/>
                        </td>
						 <td align="right" >Discount :</td>
                        <td align="left" >
                            <input type="text" name="conamt"  value="<?php echo $disc ?>" id="conamt"  class="text" readonly/>
                        </td>
                    </tr>
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="paid"  value="<?php echo $paid ?>"  id="paid" class="text" readonly/>
                        </td>
                    </tr>-->
					<tr >
                      <!--  <td align="right" >Balance Amount :</td>
                        <td align="left" >
                            <input type="text" name="bal"  value="<?php echo $bal ?>"  id="bal" class="text" readonly/>
