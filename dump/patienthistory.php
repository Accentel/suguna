...
$string=$bno[0];
				 if($string=="O"){
					$sql= mysql_query("select b.BillDate,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from outerbill b,outerbill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'");
				 }else{
...
<div class="page">
		...
		if($string=="O"){
				$sql1=mysql_query("SELECT BillDate,TestName, Amount FROM outerbill WHERE BillNO = '$bno'");
				 }else{
	  ...
	  $r=mysql_query("select * from duebill where billno='$bno'") or die(mysql_error());
	  $i=1;
	  $t1="0";
