...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
	...
	<?php
			...
			$sql= mysqli_query($link,"select b.BillDate,b.phoneno,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount,b1.time from bill b,bill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'") or die(mysqli_error($link));
			if($sql)
			{
      ...
      <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:10px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
			...
			<tr>
            <td style="padding-left:20px;font-size:14px;" >   <img src="gpay.png" alt="Alternative Text" height="200" width="300"> </td>
