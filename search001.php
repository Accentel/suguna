...
<tr><td>HAEMOGLOBIN</td><td> : <input type="text" name="HAEMOGLOBIN" size="10"/> %</td><td><input type="hidden" name="cbpid" value="<?php echo $id; ?>"/>Male : <input type="text" name="hm" value="<?php echo mysqli_real_escape_string($link,$hm); ?>"/> <input type="text" name="hnormal" size="5" value="<?php echo $hnormal; ?>" /> ,<br/> Female : <input type="text" name="hf" value="<?php echo $hf; ?>"/> <input type="text" name="hnormal" size="5" value="<?php echo $hnormal; ?>" /></td></tr>
...
<tr><td>P.C.V</td><td> : <input type="text" name="pvc" size="10"/> %</td></tr>

<tr><td>M.C.V</td><td> : <input type="text" name="mcv" size="10"/> %</td></tr>

<tr><td>M.C.H</td><td> : <input type="text" name="mch" size="10"/> pg</td></tr>

<tr><td>M.C.H.C</td><td> : <input type="text" name="mchc" size="10"/> %</td></tr>
...
<?php
}if(($q == "Complete hemogram") or ($q == "Hemogram")){
?>
<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr height="20px"></tr>
<?php
...
<tr><td>EOSINOPHILS</td><td> : <input type="text" name="EOSINOPHILS" size="10"/> %</td><td><input type="text" name="ea" value="<?php echo $ea; ?>"/>%</td><td><input type="text" name="ec" value="<?php echo $ec; ?>"/>%</td></tr>	  				
<tr><td>BASOPHILS</td><td> : <input type="text" name="BASOPHILS" size="10"/> %</td><td><input type="text" name="baa" value="<?php echo $baa; ?>"/>%</td><td><input type="text" name="bac" value="<?php echo $bac; ?>"/>%</td></tr>
<tr><td>P.V.C</td><td> : <input type="text" name="pvc" size="10"/> %</td><td><input type="text" name="pvcn" value="<?php echo $pcvn; ?>"/>%</td></tr>

<tr><td>M.C.V</td><td> : <input type="text" name="mcv" size="10"/> %</td><td><input type="text" name="mcvn" value="<?php echo $mcvn; ?>"/>%</td></tr>

<tr><td>M.C.H</td><td> : <input type="text" name="mch" size="10"/> pg</td><td><input type="text" name="mchn" value="<?php echo $mchn; ?>"/>%</td></tr>

<tr><td>M.C.H.C</td><td> : <input type="text" name="mchc" size="10"/> %</td><td><input type="text" name="mchcn" value="<?php echo $mchcn; ?>"/>%</td></tr>
...
<tr height="5px"></tr>
<tr><td>C - Reactive Protein (CRP)</td><td> : <input type="text" name="CRPRESULT" size="20" /> mg/dl</td><td><input type="hidden" name="crpid" value="<?php echo $crpid; ?>" size="5"/><input size="5" type="text" name="res" value="<?php echo $value; ?>"/><input type="text" name="type" value="<?php echo $type; ?>" size="5"/></td></tr> 
...
<tr><td>S.ALKALINE PHOSPHATE</td><td> : <input type="text" name="LFTSAPHOSPHATE" size="10" /> U/L</td><td><input type="text" name="slv1" value="<?php echo $slv1; ?>" size="20"/><input type="text" name="slvt" value="<?php echo $slvt; ?>" size="5"/></td></tr> 
<tr><td></td><td></td><td><input type="text" name="slv2" value="<?php echo $slv2; ?>" size="20"/><input type="text" name="slvt" value="<?php echo $slvt; ?>" size="5"/></td></tr> 
<tr><td></td><td></td><td><input type="text" name="slv3" value="<?php echo $slv3; ?>" size="20"/><input type="text" name="slvt" value="<?php echo $slvt; ?>" size="5"/></td></tr> 
<tr><td></td><td></td><td><input type="text" name="slv4" value="<?php echo $slv4; ?>" size="20"/><input type="text" name="slvt" value="<?php echo $slvt; ?>" size="5"/></td></tr> 
<tr><td></td><td></td><td><input type="text" name="slv5" value="<?php echo $slv5; ?>" size="20"/><input type="text" name="slvt" value="<?php echo $slvt; ?>" size="5"/></td></tr> 
<tr height="5px"></tr>
...
<tr><td align="left"><b><u>TEST </u></b></td><td ><b><u>RESULT </u></td><td ><b><u>NORMAL RANGE </u></td></tr> 
<tr height="5px"></tr>
<tr><td width="30%">Sodium</td><td> : <input type="text" name="sodium"/> mmol/l</td><td><input type="hidden" name="seid" value="<?php echo $seid; ?>" size="3"/><input type="text"  name="svalue" value="<?php echo $svalue; ?>" size="8"/><input type="text" name="stype" value="<?php echo $stype; ?>" size="5"/></td></tr> 
<tr><td width="30%">Potassium</td><td> : <input type="text" name="potash"/> mmol/l</td><td><input type="text" name="pvalue" value="<?php echo $pvalue; ?>" size="8"/><input type="text" name="stype" value="<?php echo $stype; ?>" size="5"/></td></tr> 
<tr><td width="30%">Chloride</td><td> : <input type="text" name="chloride"/> mmol/l</td><td><input type="text" name="cvalue" value="<?php echo $cvalue; ?>" size="8"/><input type="text" name="stype" value="<?php echo $stype; ?>" size="5"/></td></tr> 
...
<tr height="5px"></tr>
<tr><td width="30%">BETA HUMAN CHORIONIC 
GONADOTROPIN LEVEL  (B-HCG)    
</td><td> : <input type="text" name="haresult"/>              </td></tr> 
...
<input type="text" name="rbstype1" value="<?php echo $rbstype1; ?>" size="6"/>
</td></tr> 
...
<tr height="5px"></tr>
<tr><td>Bleeding Time (BT)</td><td> : <input type="text" name="bt" value="00' Min 00'' Sec" size="20" /></td><td><input type="hidden" name="bdlid" value="<?php echo $bdlid ?>"/><input type="text" name="btv" value="<?php echo $btv ?>" size="25"/> </td></tr> 
<tr><td>Clotting Time (CT)</td><td> : <input type="text" name="ct" value="00' Min 00'' Sec" size="20" /></td><td><input type="text" name="ctv" value="<?php echo $ctv ?>" size="25"/></td></tr> 
...
<tr height="5px"></tr>
<tr><td>Fasting Blood Sugar</td><td> : <input type="text" name="fbs" size="20" /> mg/dl</td><td><input type="hidden" name="bsid" value="<?php echo $bsid; ?>" size="5"/><input size="5" type="text" name="fbsvalue" value="<?php echo $fbsvalue; ?>"/><input size="5" type="text" name="type" value="<?php echo $type; ?>"/></td></tr> 
<tr><td>Fasting Urine Sugar</td><td> : <input type="text" name="fus" size="20" /></td></tr> 
<tr><td>Post Lunch Bloob Sugar</td><td> : <input type="text" name="plbs" size="20" /> mg/dl</td><td><input size="5" type="text" name="plbsvalue" value="<?php echo $plbsvalue; ?>"/><input size="5" type="text" name="type" value="<?php echo $type; ?>"/></td></tr> 
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr height="5px"></tr>
<tr><td width="30%">RA FACTOR</td><td> : <td><input type="text" name="raf" size="20"/></td><td><input type="hidden" type="rfid" name="aid" value="<?php echo $rfid; ?>" size="4"/><input type="text" name="rfvalue" value="<?php echo $rfvalue; ?>" size="10"/><input type="text" name="rftype" value="<?php echo $rftype; ?>" size="4"/></td></tr> 

</table>

<?php }else if($q == "PACKED CELL VOLUME(PCV)"){
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr height="5px"></tr>
<tr><td width="30%">PACKED CELL VOLUME(PCV)</td><td> : <input type="text" name="pcv" size="10"/> %</td><td>Males : <input type="hidden" name="pcvid" value="<?php echo $pcvid; ?>" size="4"/><input type="text" name="pcvm" value="<?php echo $pcvm; ?>" size="10"/><input type="text" name="pcvtype" value="<?php echo $pcvtype; ?>" size="4"/> <br>Females : <input type="text" name="pcvf" value="<?php echo $pcvf; ?>" size="10"/><input type="text" name="pcvtype" value="<?php echo $pcvtype; ?>" size="4"/></td></tr> 

</table>
<?php }else if($q == "COOMBS TEST(DIRECT)"){
?>
<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr height="5px"></tr>
...
<?php }else if($q == "COOMBS TEST(INDIRECT)"){
?>
<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr height="5px"></tr>
...
<tr><td width="30%">SGOT </td><td><input type="text" name="sgpt" size="10"/></td><td><input type="hidden" name="lfid" value="<?php echo $lfid; ?>" size="4"/><input type="text" name="sgptv" value="<?php echo $sgptv; ?>" size="4"/> <input type="text" name="sgtt" value="<?php echo $sgtt; ?>" size="4"/> </td></tr> 
