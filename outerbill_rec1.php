...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
	...
	<?php
			...
			$sql= mysqli_query($link,"select b.BillDate,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from outerbill2 b,outerbill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'") or die(mysqli_error($link));
			if($sql)
			{
  ...
  <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:10px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			...
			<?php	
				$sql1=mysqli_query($link,"SELECT TestName,Amount FROM outerbill2 WHERE BillNO = '$bno'") or die(mysqli_error($link));
				if($sql1){
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <input type="button" value="Close" id="cls" class="butt" onclick="self.location='new_lab_outerbill.php'"/></td>
      </tr>
        </table>
