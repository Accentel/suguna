...
// $e="update bill1 set PatientName='$pname',time='$time', Age='$age', Sex='$gender', DoctorName='$dname', Total='$tot', Discount='$conamt', NetAmount='$price', PaidAmount='$paid', BalanceAmount='$bal' where BillNO='$bno'";
 $e="update bill1 set PatientName='$pname',time='$time', Age='$age', Sex='$gender', DoctorName='$dname', PaidAmount='$paid' where BillNO='$bno'";
