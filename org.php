...
if(isset($_POST['submit'])){
	...
	$sq=mysqli_query($link,"update org set org='$cname',address='$addr',phno='$phone1',rname='$rname1',rphone='$rphone1',pstatus='$det',pstatus1='$det3',s1='$sig1',s2='$sig2',sstatus='$det1',sstatus1='$det2' where id=$id") or die(mysqli_error($link));
	if($sq){
		print "<script>";
