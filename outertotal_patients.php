...
<table width="100%" cellpadding="0" cellspacing="0"> 
	...
	<tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header">Outer Patients List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
						...
						$qry=mysqli_query($link,"select distinct BillNO,BillDate,PatientName,Age,Sex from outerbill1 where BillDate between '$sdate1' and '$edate1'") or die(mysqli_error($link));
						if($qry){
						$i=0;
