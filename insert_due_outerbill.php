...
$sql1 = mysqli_query($link,"update outerbill1 set PaidAmount='$paid1',BalanceAmount='$rbal',BillDate='$bdate' where BillNO='$bno'") or die(mysqli_error($link));
...
if($sql1)
{
	...
	print "self.location='pay_due_outerbill.php';";
	print "</script>";
	}
}
?>