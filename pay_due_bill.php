...
document.getElementById("rbal").value=rbal;
	...
	<body>
		...
		<?php
		$q=$_REQUEST['q'];
		$sql="select b.BillNO,b.BillDate, b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount FROM bill b,bill1 b1 WHERE b.BillNO=b1.BillNO and b1.BillNO = '$q' ";
...
?>
		  ...
		  <form name="frm" method="post" action="insert_due_bill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table">
                    ...
                    <tr>
					 ...
					 <?php 
						$sql2 = mysqli_query($link,"select * from bill where BillNO = '$q'")or die(mysqli_error($link));
						if($sql2){
