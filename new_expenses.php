                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								$sql = mysqli_query($link,"select * from expensemstr where date='$prdname' order by date desc") or die(mysqli_error($link));
							}else{
								$sql = mysqli_query($link,"select * from expensemstr order by date desc") or die(mysqli_error($link));
							}
							if($sql){
