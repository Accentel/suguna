                ...
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                       ...
                       <tr>
                        ...
                        <?php
							$qry=mysql_query("select distinct TestName,Amount from outerbill where BillDate between '$sdate1' and '$edate1'");
							if($qry){
								$i=0;
								$grand = 0;
								while($row = mysql_fetch_array($qry)){
									$tname = $row['TestName'];
									$amt = $row['Amount'];
									$qry1=mysql_query("select count(TestName) from outerbill where BillDate between '$sdate1' and '$edate1' and TestName='$tname'");
									if($qry1)
									{
