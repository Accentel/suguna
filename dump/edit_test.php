...
$sql=mysql_query("select * from testdetails where Department='$dept' and TestName='$tname'");
if($sql){
		...
		<div id="centre" style="height:auto;" >
		  ...
		  <form name="frm" class="form-horizontal" method="post" action="update_test.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table">
					...
					<?php
					$sql1=mysql_query("select * from testdetails where Department='$dept' and TestName='$tname'");
					if($sql1){	
					...
					<?php
					$sql2=mysql_query("select * from testdetails where Department='$dept' and TestName='$tname'");
					if($sql2){	
