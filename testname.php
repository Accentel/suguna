...
<tr><td width="30%">Test</td><td><input type="text" name="dsrigg" size="20"/></td><td><input type="hidden" name="dsid" value="<?php echo $dsid; ?>"/><input type="text" name="iggvalue" value="<?php echo $iggvalue; ?>"/> </td></tr> 
<tr><td width="30%">Data</td><td><input type="text" name="dsrigm" size="20"/></td><td> <input type="text" name="igmvalue" value="<?php echo $igmvalue; ?>"/> </td></tr> 
<tr><td width="30%">cont</td><td><input type="text" name="dsrns1" size="20"/></td><td> <input type="text" name="ns1value" value="<?php echo $ns1value; ?>"/> </td></tr> 

</table>
<?php }if($tname == "DENGUE NS1"){

?>
<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr height="5px"></tr>
<tr><td style="color:red;"><b><u>DENGUE NS1 : </u></b></td></tr>
<tr height="5px"></tr>

<tr><td width="30%">DENGUE NS1</td><td><input type="text" name="dsrns1" size="20"/></td><td><input type="hidden" name="dsrns1" value=""/> </td></tr> 
...
<?php }else if($tname == "NS1"){
	   $mbs="select * from ns1value where id='1'";
	   $r=mysqli_query($link,$mbs) or die(mysqli_error($link));
	   $row=  mysqli_fetch_array($r);
	   $id=$row['id'];
	   $ns1=$row['ns1'];
...
<tr><td width="30%">NS1</td><td><input type="text" name="ns1" size="20"/></td><td><input type="hidden" name="id" value=""/> </td></tr> 
