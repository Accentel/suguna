...
xmlhttp.send();
	...
	<body>
		  ...
		  <?php
			...
			//	$sql = mysqli_query($link,"select b.BillNO,b.BillDate,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from bill b,bill1 b1 where b.BillNO=b1.BillNO and  b.BillNO = '$bno'");
				$sql = mysqli_query($link,"select Pname as PatientName, BillNo as BillNO,Age,Sex,DoctorName  from reportentry where BillNo = '$bno'");
			if($sql){
		  ...
		  <form name="frm" method="post" action="update_result.php">
			<table width="100%" border="0" cellpadding="4" class="table" cellspacing="0">
                    ...
                    <tr >
                        ...
                        <td align="left" >
                            <input type="text" name="bno" id="bno" class="text" value="<?php echo $billno; ?>" onfocus="showHint(this.value)"/><br/><b style="color:red;">(Note:please click on bill no)</b>
                        </td>
