                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								$sql = mysqli_query($link,"select * from ddetails where DoctorName='$prdname'")or die(mysqli_error($link));
							}else{
								$sql = mysqli_query($link,"select * from ddetails ")or die(mysqli_error($link));
							}
							if($sql){
