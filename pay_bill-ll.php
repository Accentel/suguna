		  ...
		  <form name="myform" method="post" action="insert_bill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr >
                        ...
                        <td align="left" >
                            <input type="text" name="bno" id="bno" value="<?php echo $bno ?>" readonly class="text"/><input type="hidden" name="user" value="<?php echo $_SESSION['suguna']; ?>"/>
                        </td>
					...
					<table width="100%" id="TABLE1">
					  <thead>
					   ...
					   <tr>
					   <td ><input type="text" class="text" name="tname[]"  id="cname1" onblur="showHint21(this.value);" required/></td>
						<td ><input type="text" class="text  txt" name="cost[]" id="cost1"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname2" onblur="showHint22(this.value);" /></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost2"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname3" onblur="showHint23(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost3"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname4" onblur="showHint24(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost4"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname5" onblur="showHint25(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost5"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname6" onblur="showHint26(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost6"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname7" onblur="showHint27(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost7"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname8" onblur="showHint28(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost8"  readonly/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname9" onblur="showHint29(this.value);"/></td>
						<td ><input type="text" class="text txt" name="cost[]" id="cost9"  /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text" name="tname[]" id="cname10" onblur="showHint30(this.value);"/></td>
					...
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="tot"  readonly="readonly"  id="tot" class="text"/>
                        </td>
