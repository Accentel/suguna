...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
	...
	<?php
			...
			$sql= mysqli_query($link,"select b.BillDate,b.phoneno,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount,b1.time from outerbill b,outerbill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'") or die(mysqli_error($link));
			if($sql)
			{
		...
		<table width="100%" border="0" align="center" style="font-size:10px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			...
			<?php	
				$sql1=mysqli_query($link,"SELECT TestName,Amount FROM outerbill WHERE BillNO = '$bno'") or die(mysqli_error($link));
				if($sql1){
         ...
         <tr>
            ...
            <td class="label1" >&nbsp;</td>
			 <td class="label1" >&nbsp;</td>
            <td class="label1" >&nbsp;</td>
			<td style="padding-left:20px;font-size:14px;" >  <b></b> </td>
            </tr>
			
			<tr>
			<td style="padding-left:20px;font-size:14px;" >   <img src="pay.png" alt="Alternative Text" height="800" width="900"> </td>
			<td style="padding-left:20px;font-size:14px;" ><center>	 <b>UPI PAYMENT QR CODE/NUMBER</b> </br> <b>9848649952</b></center> </td>
            <td class="label1" >&nbsp;</td>
			<td style="padding-left:20px;font-size:14px;" >  <b>Incharge</b></br> <b><?php echo $empname; ?></b>  </td>
            </tr>
        </table></td>
      </tr>
      <tr><td align="center" >
