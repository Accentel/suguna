function actb1(obj,ca){
	/* ---- Public Variables ---- */
	this.actb1_timeOut = -1; // Autocomplete Timeout in ms (-1: autocomplete never time out)
	this.actb1_lim = 5;    // Number of elements autocomplete can show (-1: no limit)
	...
	/* --- Styles --- */
	this.actb1_bgColor ='#E1C4FF';//'#5CE3D9';// '#888888';
	//this.actb1_borderColor ='red';//'#5CE3D9';// '#888888';

	this.actb1_textColor ='#000' ;//'#339999';//'#FF6600' ;//'#FFFFFF';
	this.actb1_tColor = '#E1C4FF';
	this.actb1_hColor ='#E1C4FF';//'#B7E2DF';// '#000000';
	this.actb1_fFamily = 'Arial';
	this.actb1_fSize = '12px';
	/**/this.actb1_nextSize = '10px';
...
//		a.style.bordercolor=actb1_self.actb1_borderColor;
		...
		for (i=0;i<actb1_self.actb1_keywords.length;i++){
			...
			r.style.backgroundColor = actb1_self.actb1_bgColor;
				c = r.insertCell(-1);
			/*new code*/	c.style.color = actb1_self.actb1_tColor;
				c.style.fontFamily = 'verdana';
				c.style.fontSize = actb1_self.actb1_nextSize;
				c.align='right';
				replaceHTML(c,'next >>');
				if (actb1_self.actb1_mouse){
					c.style.cursor = 'pointer';
	...
	function actb1_remake(){
		...
		if (actb1_rangeu > 1){
			...
			r.style.backgroundColor = actb1_self.actb1_bgColor;
			c = r.insertCell(-1);
			c.style.color = actb1_self.actb1_tColor;
			c.style.fontFamily ='verdana';
			c.style.fontSize = actb1_self.actb1_nextSize;
			c.align='left';
