...
<table width="100%" cellpadding="0" cellspacing="0"> 
	...
	<tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header">Outer Patient Insurance Due List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                      ...
                      $q="select distinct b.BillNO,b.BillDate,b.PatientName,b.BalanceAmount,b1.conce_type from outerbill1 b,outerbill b1 where b.BillNO=b1.BillNO and b.BillDate between '$sdate1' and '$edate1' and b.BalanceAmount != 0 and b1.conce_type='Insurance'";
                        ...
                        <tr>
							...
							<table width="100%">
							<?php
									$sql2 = mysqli_query($link,"select distinct TestName from outerbill where BillNO='$bno'") or die(mysqli_error($link));
									if($sql2){
