            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
						...
						<?php 
                         $qry1="select distinct a.BillNO,a.BillDate,a.PatientName,a.NetAmount,a.PaidAmount,a.BalanceAmount,b.conce_type from bill1 a,bill b  where  a.BillNO=b.BillNO and a.BillDate between '$sdate1' and '$edate1'";
                        ...
                        <tr>
							...
							<?php 
							$qry4="select  a.billno,a.billdate,a.paidamount,b.BillNO,a.user1 from duebill a,bill1 b where a.billdate between '$sdate1' and '$edate1' and   a.billno=b.BillNO and a.billno='$bno'";
					   ...
					   <tr>
						  ...
						  $qry5="select  sum(paidamount) as paid  from duebill  where  billdate between '$sdate1' and '$edate1' ";
							 $qry6=mysqli_query($link,$qry5)or die(mysqli_error($link));
							 while($r=mysqli_fetch_array($qry6)){
							echo $r['paid'];
							}
						  ?>
						  </td>
