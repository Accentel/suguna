...
<nav class="navbar navbar-inverse navbar-custom1">
  <div class="container">
	...
	<?php if($menu2 == "2"){ ?> <li><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>SETTINGS</b><span class="caret"></span></a>
	...
	<?php if($menu3 == "3"){ ?><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>BILLING</b><span class="caret"></span></a>
          <ul class="dropdown-menu">
	...
	<?php if($menu4 == "4"){ ?><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>REPORTS</b><span class="caret"></span></a>
          <ul class="dropdown-menu">
		...
		<?php if($menu8 == "8"){ ?><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>REVIEW</b><span class="caret"></span></a>
          <ul class="dropdown-menu">
             

			<?php if($menu81 == "81"){ ?><li><a href="management_info.php">REPORTS</a></li><?php } ?>
			
		  </ul>
		
    </li><?php } ?>
	
	<?php if($menu5 == "5"){ ?><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>REGISTRATION</b><span class="caret"></span></a>
          <ul class="dropdown-menu">
	...
	<?php if($menu6 == "6"){ ?><li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>DAILY CASESHEET</b><span class="caret"></span></a>
          <ul class="dropdown-menu">
