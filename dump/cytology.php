...
xmlhttp.send();
	...
	<?php include('headertop.php'); ?>
		...
		<div id="centre" style="height:auto;">
          ...
          <div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">Cytology Report</div>
		  <form name="frm" method="post" action="insert_cytology.php">
