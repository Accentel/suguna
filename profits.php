            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" style="outline:1px solid black;">
                        ...
                        <?php
							$qry=mysqli_query($link,"select * from expensemstr where date between '$sdate1' and '$edate1'")or die(mysqli_error($link));
							if($qry){
								$exp1 = 0;
							...
							$qry1=mysqli_query($link,"select distinct BillNO,PaidAmount from bill1 where BillDate between '$sdate1' and '$edate1'")or die(mysqli_error($link));
							if($qry1){
								$paid1 = 0;
							...
							$qry2=mysqli_query($link,"select distinct BillNO,PaidAmount from outerbill1 where BillDate between '$sdate1' and '$edate1'")or die(mysqli_error($link));
							if($qry1){
								$paid11 = 0;
								while($row11 = mysqli_fetch_array($qry2)){
