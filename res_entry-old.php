      ...
      <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:11px;font-family:Calibri (Body);" cellpadding="2" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			<td colspan="4">
			<table width="100%" style="padding-left:20px;font-size:11px;font-family:Calibri (Body);border-top:1px solid #000000;" cellpadding="1" cellspacing="0">
			<tr height="10px"></tr>
                        <tr><td align="left"><b><u style="font-size:15px;">TEST </u></b></td><td ><b><u style="font-size:15px;">RESULT </u></td><td><b><u style="font-size:15px;">NORMAL RANGE </u></td></tr> 
	
				
			<?php
				$sql1 = mysql_query("select distinct Ptest from reportentry where BillNo='$bno'");
				if($sql1){
					while($row1 = mysql_fetch_array($sql1)){
						$ptest = $row1[0];
				?>
				<tr><td align="center" colspan="4"><b><u></u></p></td></tr>
				<?php
				if($ptest == "COMPLETE BLOOD  PICTURE (CBP)"){	
				...
				?>
                                <tr><td colspan="2" ><b><u style="font-size:15px;">COMPLETE BLOOD  PICTURE (CBP)</u></b></tr>
				
                                <tr>
                                    <td >HAEMOGLOBIN</td>
                                    <td > : <?php echo $HAEMOGLOBIN ?> %</td>
                                    <td colspan="2" >Male : 13.0 - 18.0 g% </td>
                                </tr>
                                <tr>
                                    <td ></td>
                                    <td> </td>
                                    <td colspan="2" >Female : 11.5 - 16.0 g%</td>
                                </tr>
                                <tr>
                                    <td >RBC</td>
                                    <td> : <?php echo $RBC ?> Mill/ cumm</td>
                                    <td colspan="2" >Male : 4.5 - 6.5 Mill/Cumm</td>
                                </tr>
                                <tr>
                                    <td ></td>
                                    <td> </td>
                                    <td colspan="2" >Female : 3.5 - 5.5 Mill/Cumm</td>
                                </tr>
...
if($ptest == "COMPLETE URINE EXAMINATION(CUE)"){	
...
<tr><td colspan="2" ><b><u>COMPLETE URINE EXAMINATION(CUE)</u></b></tr>
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
		...
		if($ptest == "C - Reactive Protein (CRP)"){	
...
<tr height="5px"></tr>
<tr><td>C - Reactive Protein (CRP)</td><td> : <?php echo $CRPRESULT ?> mg/l</td><td><?php echo  "< 6-8 mg/l"; ?></td></tr> 
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
<tr><td colspan="4">(Method:Immunoturbidimetric)</td></tr>

		<?php }
		
		if($ptest == "LIVER FUNCTION TEST"){	
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
		<?php }
                ...
                if($ptest == "Smear for Malarial Parasite"){	
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
		<?php }
                ...
                if($ptest == "Absolute Eosinophil Count (AEC)"){	
...
<tr><td colspan="4"><b>Consultant Pathologist</b></td></tr>
		...
		<?php }
                ...
                if($ptest == "Erythrocyte Sedimentation Rate (ESR)"){	
...
<tr><td >Sodium</td><td> : <?php echo $sodium ?> mmol/l</td><td>135 - 155 mmol/l</td></tr> 
<tr><td >Potassium</td><td> : <?php echo $potash ?> mmol/l</td><td>3.5 - 5.5 mmol/l</td></tr> 
<tr><td >Chloride</td><td> : <?php echo $chloride ?> mmol/l</td><td>95 - 105 mmol/l</td></tr> 
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
		<?php }
                
                
                if($ptest == "Random Blood Sugar (RBS)"){	
...
<tr height="5px"></tr>
<tr><td >Blood Urea</td><td> : <?php echo $burea ?> mg/dl</td><td>10 - 50 mg/dl</td></tr> 
		<?php }if($ptest == "Serum Creatinine"){	
...
<tr height="5px"></tr>
<tr><td >Serum Creatinine</td><td> : <?php echo $sresult ?> mg/dl</td><td>0.6 - 1.5 mg/dl</td></tr> 
...
<tr height="5px"></tr>
<tr><td >SERUM CALCIUM</td><td> : <?php echo $calresult ?> mg/dl</td><td>8.5 - 10.5 mg/dl</td></tr> 
		<?php }if($ptest == "Prothrombin Time (PT)"){	
...
<tr><td colspan="4"><b>Consultant Pathologist</b></td></tr>
		...
		<?php }if($ptest == "Activated Partial Thromboplastin Time (APTT)"){	
...
<tr height="5px"></tr>
<tr><td>Serum Uric Acid</td><td> : <?php echo $suaresult ?> mg/dl</td><td>Male : 3.6 - 7.7 mg/dl<br>Female : 2.5 - 6.8 mg/dl</td></tr> 
		
    
<tr><td colspan="4"><br/><br/></td></tr>
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
    <?php }if($ptest == "COMPLETE STOOL EXAMINATION"){	
...
<tr height="5px"></tr>
<tr><td>HBsAg</td><td> : <?php echo $hresult ?></td></tr>
...
<tr height="5px"></tr>
<tr><td  colspan="2"><b>WIDAL : </b></td></tr> 
<tr height="5px"></tr>
...
<tr height="5px"></tr>
<tr><td >HAEMOGLOBIN</td><td> : <?php echo $haresult ?> % </td><td>Male : 13.0 - 18.0 g%<br>Female : 11.5 - 16.0 g%</td></tr> 
...
<tr height="5px"></tr>
<tr><td >Random Blood Sugar (RBS)</td><td> : <?php echo $rftrbs ?> mg/dl</td><td>60 - 160 mg/dl</td></tr> 
<tr><td >Blood Urea</td><td> : <?php echo $rftbu ?> mg/dl</td><td>10 - 50 mg/dl</td></tr> 
<tr><td >Serum Creatinine</td><td> : <?php echo $rftscr ?> mg/dl</td><td>0.6 - 1.5 mg/dl</td></tr> 
<tr><td >Serum Uric Acid</td><td> : <?php echo $rftsua ?> mg/dl</td><td>Male : 3.6 - 7.7 mg/dl<br>Female : 2.5 - 6.8 mg/dl </td></tr> 
<tr><td >Serum Calcium</td><td> : <?php echo $rftsc ?> mg/dl</td><td>8.5 - 10.5 mg/dl</td></tr> 
<tr height="5px"></tr>
<tr><td style="color:red;" colspan="2"><b><u>Serum Electrolytes:</u></b></td></tr>

<tr><td >Serum Sodium</td><td> : <?php echo $rftsodium ?> mmol/l</td><td>135 - 155 mmol/l</td></tr> 
<tr><td >Serum Potassium</td><td> : <?php echo $rftpotash ?> mmol/l</td><td>3.5 - 5.5 mmol/l</td></tr> 
<tr><td >Serum Chloride</td><td> : <?php echo $rftchloride ?> mmol/l</td><td>95 - 105 mmol/l</td></tr> 
		
		<?php }
                
                
                if($ptest == "Reducing Substance"){	
...
<tr><td>Indirect Bilirubin</td><td> : <?php echo $ibil ?> mg/dl</td><td></td></tr> 
		<?php }
                ...
                if($ptest == "BLEEDING TIME AND CLOTTING TIME"){	
...
<tr height="5px"></tr>
<tr><td valign="top">Serum Cholesterol</td><td valign="top"> : <?php echo $sch ?> mg/dl</td><td >Normal upto 200 mgs/dl<br>Boderline Upto 239 mgs/dl<br>Elevated > 240 mgs/dl.</td></tr> 
<tr height="5px"></tr>
<tr><td valign="top">HDL Cholesterol</td><td valign="top"> : <?php echo $hch ?> mg/dl</td><td>30 - 60 mgs/dl</td></tr> 
<tr height="5px"></tr>
<tr><td valign="top">LDL Cholesterol</td><td valign="top"> : <?php echo $lch ?> mg/dl</td><td>100 - 190 mg/dl<br>Elevated > 190 mg/dl</td></tr> 
<tr height="5px"></tr>
<tr><td valign="top">VLDL Cholesterol</td><td valign="top"> : <?php echo $vch ?> mg/dl</td><td>05 - 35 mg/dl</td></tr> 
<tr height="5px"></tr>
<tr><td valign="top">Serum Triglycerides</td><td valign="top"> : <?php echo $stri ?> mg/dl</td><td>Normal less than 180 mg/dl<br>Boderline 180 - 220 mg/dl<br>High > 220 mg/dl</td></tr> 
<tr height="5px"></tr>
<tr><td valign="top">T.CHOL / HDL RATIO</td><td valign="top"> : <?php echo $tch ?></td><td>less than 4.0 Normal<br>4.0 - 6.0 Boderline<br> > 6.0 High Risk</td></tr> 
...
<tr height="5px"></tr>
<tr><td>PLATELET COUNT</td><td> : <?php echo $pcount ?> lakhs /cumm</td><td>1.5 - 4.5Lakhs/cumm</td></tr>
		<?php }
                
                if($ptest == "SERUM CHOLESTEROL"){	
...
<tr height="5px"></tr>
<tr><td>Serum Cholesterol</td><td> : <?php echo $schole ?> mg/dl</td><td>Normal upto 200 mgs/dl<br>Boderline Upto 239 mgs/dl<br>Elevated > 240 mgs/dl.</td></tr> 
...
<tr height="5px"></tr>
<tr><td>Serum Triglycerides</td><td> : <?php echo $strig ?> mg/dl</td><td>Normal less than 180 mg/dl<br>Boderline 180 - 220 mg/dl<br>High > 220 mg/dl</td></tr> 
		<?php }if($ptest == "ALKALINE PHOSPHATE"){	
...
<tr height="5px"></tr>
<tr><td>Serum Potassium</td><td> : <?php echo $spotash ?> mmol/l</td><td>3.5 - 5.5 mmol/l</td></tr> 
		<?php }if($ptest == "Smear for Microfilaria"){	
...
<tr><td >HBA1C</td><td> : <?php echo $hba ?> %</td><td>6.5 to 7%</td></tr> 
		<?php }if($ptest == "COOMBS TEST(DIRECT)"){	
...
<tr><td>COOMBS TEST (DIRECT)</td><td> : <?php echo $ctd ?></td></tr> 
		<?php }if($ptest == "COOMBS TEST(INDIRECT)"){	
...
<tr><td>COOMBS TEST(INDIRECT)</td><td> : <?php echo $ctid ?></td></tr> 
		<?php }if($ptest == "PACKED CELL VOLUME(PCV)"){	
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
 ...
 <tr><td colspan="4"><b>Kindly Correlate Clinically</b></td></tr>
	<tr>
