                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								$sql = mysqli_query($link,"select * from masterdept where deptname='$prdname'") or die(mysqli_error($link));
							}else{
								$sql = mysqli_query($link,"select * from masterdept ")  or die(mysqli_error($link));;
							}
							if($sql){
