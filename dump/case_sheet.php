...
if (document.myform.fdate.value=="") {
	...
	window.open('casesheet_report.php?s_date='+s_date+'&e_date='+e_date,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>
	</head>
...
<?php
			...
			<div id="centre" >
					<div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">Daily Case Sheet</div>
