...
<table width="100%" align="center" class="table  table-bordered" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
      <td >
...
<!--                <table width="100%" border="0" align="center"  cellpadding="5" cellspacing="0" >
	...
	<?php
		...
		?>
    <tr colspan="2"><td height="80">&nbsp;</td> </tr>
  <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:11px;font-family:Calibri (Body);" cellpadding="2" cellspacing="0" >
         ...
         <td style="padding-left:20px;"><div align="left">Patient Name </div></td>
		  ...
		  <tr>
			...
			<?php
				$sql1 = mysqli_query($link,"select distinct Ptest from reportentry where BillNo='$bno'");
				if($sql1){
				...
				$sql2 = mysqli_query($link,"select * from cbp where bill_no='$bno'");
				if($sql2){
...
$r=  mysqli_query($link,$mbss) or die(mysql_error());
...
?>
				...
				<tr><td colspan="4" align="center" ><b><u style="font-size:13px;">COMPLETE BLOOD  PICTURE (CBP)</u></b></tr>
				 <tr><td align="left"><b><u style="font-size:12px;">TEST </u></b></td><td ><b><u style="font-size:12px;">RESULT </u></td><td><b><u style="font-size:12px;">REFERENCE RANGE </u></td></tr> 
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" >Male : <?php echo $hm; ?> <?php echo $hnormal; ?> </td>
                                </tr>
                                <tr>
                                    <td ></td>
                                    <td> </td>
                                    <td colspan="2" >Female : <?php echo $hf; ?> <?php echo $hnormal; ?></td>
                                </tr>
                                <tr>
                                    <td >RBC</td>
                                    <td> : <?php echo $RBC ?> Mill/ cumm</td>
                                    <td colspan="2" >Male : <?php echo $rbcm; ?> <?php echo $rbcnormal; ?></td>
                                </tr>
                                <tr>
                                    <td ></td>
                                    <td> </td>
                                    <td colspan="2" >Female : <?php echo $rbcf; ?> <?php echo $rbcnormal; ?></td>
                                </tr>
...
if($ptest == "COMPLETE URINE EXAMINATION(CUE)"){	
		...
		<div style="height:700">
<tr><td colspan="4" align="center" ><b><u>COMPLETE URINE EXAMINATION(CUE)</u></b></tr>
...
if($ptest == "MANTOUX TEST"){	
		...
		<div style="height:700">
<tr><td colspan="4" align="center" ><b><u>MANTOUX REPORT</u></b></tr>
<tr><td colspan="2" ><b><u>TEST</u></b></tr>
...
$r=  mysqli_query($link,$mbs) or die(mysql_error());
$row=  mysqli_fetch_array($r);
$crpid=$row['crpid'];
...
<tr><td align="left"><b><u style="font-size:15px;">TEST </u></b></td><td ><b><u style="font-size:15px;">RESULT </u></td><td colspan="2"><b><u style="font-size:15px;">REFERENCE RANGE </u></td></tr>
<tr height="5px"></tr>
<tr><td>C - Reactive Protein (CRP)</td><td> : <?php echo $CRPRESULT ?> <?php echo  "&nbsp;&nbsp;".$type; ?></td><td><?php echo  $value."&nbsp;&nbsp;".$type; ?></td></tr> 
...
$r1=  mysqli_query($link,$mbq) or die(mysql_error());
...
<tr><td colspan="4"><b>Consultant Pathologist</b></td></tr>
		...
		<?php }
                ...
                if($ptest == "Activated Partial Thromboplastin Time (APTT)"){	
...
<tr><td colspan="4" align="center" ><b><u>BIO-CHEMISTRY REPORT</u></b></tr>
<tr><td align="left"><b><u style="font-size:12px;">TEST </u></b></td><td ><b><u style="font-size:12px;">RESULT </u></td><td><b><u style="font-size:12px;">REFERENCE RANGE </u></td></tr>
<tr><td>Serum Uric Acid</td><td> : <?php echo $suaresult ?> <?php echo "&nbsp;&nbsp;".$sumv;?></td><td>Male :<?php echo $sum."&nbsp;&nbsp;".$sumv;?><br>Female :<?php echo $suf."&nbsp;&nbsp;". $sufv;?></td></tr> 
...
<tr><td colspan="4"><b>Consultant Pathologist</b></td></tr>
    ...
    if($ptest == "RFT"){	
		$sql2 = mysqli_query($link,"select * from rft where bill_no='$bno'");
		if($sql2){
		...
		$rftchlodride = $row2['rft_chloride'];
                ...
                $r1=  mysqli_query($link,"select * from rbsrange where rbsid='1'") or die(mysql_error());
$row=  mysqli_fetch_array($r1);
$rbsid1=$row['rbsid'];
$rbsvalue1=$row['rbsvalue'];
$rbstype1=$row['rbstype'];
    
$r1=  mysqli_query($link,"select * from bunormals where buid='1'") or die(mysql_error());
$row=  mysqli_fetch_array($r1);
$buid1=$row['buid'];
$buvalue1=$row['buvalue'];
$butype1=$row['butype'];

$r1=  mysqli_query($link,"select * from creatinormals where cid='1'") or die(mysql_error());
$row=  mysqli_fetch_array($r1);
$cid1=$row['cid'];
$cvalue1=$row['cvalue'];
$ctype1=$row['ctype'];
...
$r1=  mysqli_query($link,"select * from scnormal where scid='1'") or die(mysql_error());
$row=  mysqli_fetch_array($r1);
$scid1=$row['scid'];
...
$r1=  mysqli_query($link,"select * from sele where seid='1'") or die(mysql_error());
$row=  mysqli_fetch_array($r1);
$seid1=$row['seid'];
$svalue1=$row['svalue'];
$pvalue1=$row['pvalue']; 
...
<tr><td >Serum Chloride</td><td> : <?php echo $rftchlodride."&nbsp;&nbsp;".$stype1; ?> </td><td><?php echo $cvalue1."&nbsp;&nbsp;".$stype1; ?></td></tr> 
...
<tr><td align="left"><b><u style="font-size:12px;">TEST </u></b></td><td ><b><u style="font-size:12px;">RESULT </u></td><td><b><u style="font-size:12px;">REFERENCE RANGE </u></td></tr>
<tr><td>Serum Cholesterol</td><td> : <?php echo $schole ?> mg/dl</td><td><?php echo $schnormal."&nbsp;&nbsp;".$schtype ?><br/><?php echo $schborderline."&nbsp;&nbsp;".$schtype ?><br/><?php echo $schevelated."&nbsp;&nbsp;".$schtype ?></td></tr> 
...
<tr><td>TOTAL PROTIENS </td><td> : <?php echo $tprt."&nbsp;&nbsp;".$tpty; ?> </td><td><?php echo $tpva."&nbsp;&nbsp;".$tpty; ?></td></tr> 
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
    <?php }
                ...
                if($ptest == "Smear for Microfilaria"){	
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
		<?php }
                ...
                if($ptest == "HBA1C"){	
		$sql2 = mysqli_query($link,"select * from hba where bill_no='$bno'");
		if($sql2){
...
<tr><td colspan="3"></td><td><b><?php echo $s2; ?></b></td></tr>
		<?php }
                ...
                if($ptest == "PACKED CELL VOLUME(PCV)"){	
...
<tr><td >IgM</td><td><?php echo $dsrigm ?></td><td><?php echo $igmvalue; ?></td></tr> 
