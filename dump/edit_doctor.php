...
$sql=mysql_query("select * from ddetails where DoctorName='$dn'");
if($sql){
...
$sq=mysql_query("update ddetails set DoctorName='$dname',Address='$daddr',PhNo='$dphno',Percentage='$dper' where DoctorName='$dn'");
if($sq){
	print "<script>";
