                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								$sql = mysql_query("select  a.BillNO,a.PatientName,a.NetAmount ,a.PaidAmount,a.BalanceAmount,b.ptype,b.conce_type,b.BillNO  from bill1 a,bill b where a.BillNO=b.BillNO and a.user='$name'  GROUP BY  a.BillNO  order by a.bid desc");
							}
							if($sql){
                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								$sql = mysql_query("select  a.BillNO,a.PatientName,a.NetAmount ,a.PaidAmount,a.BalanceAmount,b.ptype,b.conce_type,b.BillNO  from bill1 a,bill b where a.BillNO=b.BillNO     GROUP BY  a.BillNO  order by a.bid desc");
							}
							if($sql){
								$rows=mysql_num_rows($sql);
								if($rows > 0){
