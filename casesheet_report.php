            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" >
						...
						<?php
							//include("config.php");
							$sql1 = mysqli_query($link,"select distinct BillNO,PatientName,DoctorName,BillDate from bill1 where BillDate between '$sdate1' and '$edate1' order by bid asc") or die(mysqli_error($link));
							if($sql1){
						...
						<tr >
							...
							<table width="100%">
								<?php
									$sql2 = mysqli_query($link,"select distinct TestName,Amount,BillDate from bill where BillDate between '$sdate1' and '$edate1' and BillNO='$bno'") or die(mysqli_error($link));
									if($sql2){
									$sum = 0;
						...
						<tr >
						<?php 
						 $rr="select  sum(Amount) as Total1 from bill where BillDate between '$sdate1' and '$edate1' ";
