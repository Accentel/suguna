...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
	...
	<?php
			...
			$sql= mysql_query("select b.BillDate,b.phoneno,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from outerbill b,outerbill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'");
			if($sql)
			{
