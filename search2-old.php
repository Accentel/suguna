...
<?php
$sql3=mysql_query("SELECT Ptest FROM reportentry WHERE BillNo = '$q'");
if($sql3){
...
$sql1 = mysql_query("select Ptest from reportentry where BillNo='$q'");
if($sql1){
$i=0;
...
$sql4 = mysql_query("select count(*) from cbp where bill_no='$q'");
if($sql4){
...
<tr><td>NEUTROPHILS</td><td> : <input type="text" name="NEUTROPHILS" id="NEUTROPHILS" size="10"/> %</td><td>40-75%</td><td>30 - 40%</td></tr>
<tr><td>LYMPHOCYTES</td><td> : <input type="text" name="LYMPHOCYTES" id="LYMPHOCYTES" size="10"/> %</td><td>20-45%</td><td>40 - 60%</td></tr>
<tr><td>MONOCYTES</td><td> : <input type="text" name="MONOCYTES" id="MONOCYTES" size="10"/> %</td><td>02-10%</td><td>02 - 10%</td></tr>		 		
<tr><td>EOSINOPHILS</td><td> : <input type="text" name="EOSINOPHILS" id="EOSINOPHILS" size="10"/> %</td><td>01-06%</td><td>01 - 06%</td></tr>	  				
<tr><td>BASOPHILS</td><td> : <input type="text" name="BASOPHILS" id="BASOPHILS" size="10" onblur="javascript:fun001();"/> %</td><td>00-01%</td><td>00 - 01%</td></tr>			
<tr height="10px"></tr>
...
$sql5 = mysql_query("select * from cbp where bill_no='$q'");
if($sql5){
...
<tr height="5px"></tr>
<tr><td width="30%">Bleeding Time (BT)</td><td> : <input type="text" name="bt" value="00' Min 00'' Sec" size="20" /></td><td>01' Min 00'' Sec - 03' Min 00'' Sec</td></tr> 
<tr><td width="30%">Clotting Time (CT)</td><td> : <input type="text" name="ct" value="00' Min 00'' Sec" size="20" /></td><td>03' Min 00'' Sec - 07' Min 00'' Sec</td></tr> 
...
<tr height="5px"></tr>
<tr><td width="30%">Fasting Blood Sugar</td><td> : <input type="text" name="fbs" size="20" /> mg/dl</td><td>70 - 110 mg/dl</td></tr> 
<tr><td width="30%">Fasting Urine Sugar</td><td> : <input type="text" name="fus" size="20" /></td></tr> 
<tr><td width="30%">Post Lunch Bloob Sugar</td><td> : <input type="text" name="plbs" size="20" /> mg/dl</td><td>80 – 170 mg/dl</td></tr> 
