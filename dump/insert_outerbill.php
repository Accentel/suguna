...
echo $q="insert into outerbill1(BillNO,  PatientName, Age, Sex, DoctorName,Total,Discount,NetAmount,PaidAmount,BalanceAmount,BillDate,user,time) values('$bno','$pname','$age','$gender','$dname','$total','$disc','$namt','$paid','$bal','$bdate','$user','$time')";
...
$cost = $_POST['cost'][$i];
if($tname != ""){
$sql1 = mysql_query("insert into outerbill(BillNO, BillDate, PatientName, Age, Sex, DoctorName,TestName,Amount,Total,Discount,NetAmount,PaidAmount,BalanceAmount,conce_type,ptype,remarks,user,phoneno) values('$bno','$bdate','$pname','$age','$gender','$dname','$tname','$cost','$total','$disc','$namt','$paid','$bal','$ctype','$ptype','$remarks','$user','$mno')");
}
...
if($sql1)
{
	...
	print "</script>";
	//header("Location:new_lab_outerbill.php");
