...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background:#FFFFFF">
  <tr>
	...
	<?php
			...
			$sql= mysql_query("select b.BillDate,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from bill2 b,bill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'");
			if($sql)
			{
		...
		<table width="100%" border="0" align="center" style="font-size:10px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
		  ...
		  <tr>
			...
			<?php	
				$sql1=mysql_query("SELECT TestName,Amount FROM bill2 WHERE BillNO = '$bno'");
				if($sql1){
