            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" >
						...
						<?php
							include("config.php");
							$sql1 = mysql_query("select distinct BillNO,PatientName,DoctorName,BillDate from bill where BillDate between '$sdate1' and '$edate1'");
							if($sql1){
						...
						<tr >
							...
							<table width="100%">
								<?php
									$sql2 = mysql_query("select distinct TestName, sum(Amount) as Total,Amount,BillDate from bill where BillDate between '$sdate1' and '$edate1' and BillNO='$bno'");
									if($sql2){
									$sum = 0;
									$total=0;
						...
						<tr >
						<?php 
						echo $rr="select  sum(Amount) as Total1 from bill where BillDate between '$sdate1' and '$edate1' ";
						$sql3 = mysql_query($rr);
						...
						?>
							...
							<td valign="top" align="center"><b><?php echo $total ?></b></td>
