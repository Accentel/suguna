                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								if($prdname != "" & $pname != ""){
									$sql = mysql_query("select distinct BillNO,PatientName,NetAmount,PaidAmount,BalanceAmount from outerbill1 where BillNO='$prdname' and PatientName='$pname' order by bid desc");
								}elseif($prdname != ""){
								...
								$sql = mysql_query("select  a.BillNO,a.PatientName,a.NetAmount ,a.PaidAmount,a.BalanceAmount,b.ptype,b.conce_type,b.BillNO  from outerbill1 a,outerbill b where a.BillNO=b.BillNO and a.user='$name'  GROUP BY  a.BillNO  order by a.bid desc");
							}
							if($sql){
						   ...
						   <tr>
							 ...
							 <b style="color:red;"><?php echo $row['conce_type'] ?></b>
							  ...
							  <td><a href="#" onclick="window.open('outerbill_rec.php?bno=<?php echo $row['BillNO'] ?>','mywindow','width=1020,height=700,toolbar=no,menubar=no,scrollbars=yes')" target="new"><img src="images/green.png" height="22"/></a></td>
                                                          ...
                                                          <td><a href="edit_lab_outerbill.php?bno=<?php echo $row['BillNO'] ?>"><img src="images/edit1.jpg" style="height:21px;width:80px;"/></a></td>
                      ...
                      <tbody>
						  ...
						  <?php
							...
							if(isset($_REQUEST['submit'])){
								...
								$sql = mysql_query("select  a.BillNO,a.PatientName,a.NetAmount ,a.PaidAmount,a.BalanceAmount,b.ptype,b.conce_type,b.BillNO  from outerbill1 a,outerbill b where a.BillNO=b.BillNO     GROUP BY  a.BillNO  order by a.bid desc");
							}
							if($sql){
								$rows=mysql_num_rows($sql);
								if($rows > 0){
