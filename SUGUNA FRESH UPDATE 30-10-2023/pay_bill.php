...
window.onload=GetClock;
	...
	<?php include('headertop.php'); ?>
		...
		<?php
			...
			if($_SESSION['suguna'] == 'nanimini' or $_SESSION['suguna'] == 'NANIMINI'){
				$str = "UG -".$dt3."-";
			}
		...
		?>
		  ...
		  <form name="myform" method="post" action="insert_bill.php" class="form-horizontal">
			...
			<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table">
					...
					<tr >
                     ...
                     <tr >
					 <td colspan="4">
                       <table width="100%" id="expense_table" class="table">
		 ...
		 <div align="center"><input type="submit" name="submit" value="Save" Class="btn btn-primary"/> <input type="button" value="Close" Class="btn btn-danger" onclick="window.location.href='new_lab_bill.php'"/></div>
        </div>
		 </form>
			</div>
