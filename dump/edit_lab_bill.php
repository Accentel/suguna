...
<html>
	...
	<div id="conteneur">
		...
		<?php
			include("config.php");
			$bno = $_REQUEST['bno'];
			$sql = mysql_query("select b.BillNO,b.BillDate,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.phoneno,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount from bill b,bill1 b1 where b.BillNO=b1.BillNO and  b.BillNO = '$bno'");
			if($sql){
