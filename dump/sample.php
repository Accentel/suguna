...
<?php
		...
		//	$bno = $_REQUEST['bno'];
			 $string=$bno[0];
				 if($string=="O"){
					$sql= mysql_query("select * from outerbill where BillNO='$bno'");
				 }else{
...
<tr><td colspan="4"><br/><br/></td></tr><tr><td colspan="4">Kindly Correlate Clinically,if there's a need discuss.</td></tr>
	...
	if($emp_id1 == "BIO(CBP ESR)"){	
				$sql2 = mysql_query("select * from cbpesr where bill_no='$bno'");
				if($sql2){
...
<tr>
	...
	$sql2 = mysql_query("select * from ureacreati where bill_no='$bno'");
		if($sql2){
