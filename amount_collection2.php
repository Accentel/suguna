                        ...
                        <tr>
                         ...
                         <td align="center" ><?php echo number_format($total,2) ?></td>
							...
							<?php 
							 ...
							 $qry3=mysqli_query($link,$qry4) or die(mysqli_error($link));
							 $paid=0;
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <tr>
                <td>
					...
					//$qry1="select distinct a.BillNO,a.BillDate,a.PatientName,a.user,a.conce_type,b.NetAmount,b.BalanceAmount,b.BillNO,c.billno,c.paidamount from outerbill a inner join outerbill1 b on a.BillNO=b.BillNO inner join duebill c on a.BillNO=c.billno where c.user1='$ename' and a.BillDate between '$sdate1' and '$edate1'";
					$qry1="select distinct a.BillNO,a.BillDate,a.PatientName,a.user,b.conce_type,a.NetAmount,a.BalanceAmount,a.PaidAmount from outerbill1 a inner join outerbill b on a.BillNO=b.BillNO where a.user='$ename' and a.BillDate between '$sdate1' and '$edate1'";
