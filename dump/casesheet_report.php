            ...
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" >
						...
						<?php
							include("config.php");
							$sql1 = mysql_query("select distinct BillNO,PatientName,DoctorName,BillDate from bill1 where BillDate between '$sdate1' and '$edate1' order by bid asc");
							if($sql1){
						...
						<tr >
							...
							<table width="100%">
								<?php
									$sql2 = mysql_query("select distinct TestName,Amount,BillDate from bill where BillDate between '$sdate1' and '$edate1' and BillNO='$bno'");
									if($sql2){
									$sum = 0;
